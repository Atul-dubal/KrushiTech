...
public class WishlistProductAdapter extends RecyclerView.Adapter<WishlistProductAdapter.ViewHolder> {
    ...
    public WishlistProductAdapter(Context context, List<ProductModel> ProductDataList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context.getApplicationContext()).inflate(R.layout.wishlist_product_layout, parent, false);
