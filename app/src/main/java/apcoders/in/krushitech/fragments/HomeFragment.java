...
public class HomeFragment extends Fragment {
    ...
    private void banner_recyclerview_setup(View view) {
        ...
        imageIds.add(Uri.parse("android.resource://apcoders.in.agritech/" + R.drawable.banner_1));
        imageIds.add(Uri.parse("android.resource://apcoders.in.agritech/" + R.drawable.banner_2));
        imageIds.add(Uri.parse("android.resource://apcoders.in.agritech/" + R.drawable.banner_3));
